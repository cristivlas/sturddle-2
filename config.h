...
DECLARE_VALUE(  MULTICUT_MARGIN,                    246,    0,    1000)
DECLARE_VALUE(  NNUE_EVAL_SCALE,                    670,    0,    1000)
DECLARE_VALUE(  NNUE_ROOT_ORDER_THRESHOLD,           54,    0,     128)
DECLARE_VALUE(  NULL_MOVE_DEPTH_WEIGHT,              10,    0,     100)
DECLARE_VALUE(  NULL_MOVE_DEPTH_DIV,                  5,    1,     100)
DECLARE_VALUE(  NULL_MOVE_DIV,                      201,    1,    1000)
DECLARE_VALUE(  NULL_MOVE_FAIL_PENALTY,              55,    0,    1000)
DECLARE_VALUE(  NULL_MOVE_REDUCTION,                  4,    0,     100)
DECLARE_VALUE(  NULL_MOVE_IMPROVEMENT_DIV,           79,    1,    1000)
DECLARE_VALUE(  NULL_MOVE_MARGIN,                   655,    0,    1000)
DECLARE_VALUE(  NULL_MOVE_MIN_VERIFICATION_DEPTH,    16,    0,     100)
DECLARE_VALUE(  PROBCUT_DEPTH_FACTOR,                 2,    0,     100)
DECLARE_VALUE(  PROBCUT_MARGIN,                     424,    0,    1000)
DECLARE_VALUE(  PROBCUT_MAX_DEPTH,                   16,   10,     100)
DECLARE_VALUE(  PROBCUT_MIN_DEPTH,                    8,    3,     100)
DECLARE_VALUE(  RAZOR_DEPTH_COEFF,                  292,    0,     300)
DECLARE_VALUE(  RAZOR_INTERCEPT,                    253,    0,     300)
...
DECLARE_VALUE(  SINGULAR_ACCURACY_MARGIN,           278,    1,     500)
