...
#if CAPTURE_HISTORY
DECLARE_NORMAL(  CAPTURE_HISTORY_LMR_HIGH,           101,   27,     174)
DECLARE_NORMAL(  CAPTURE_HISTORY_LMR_LOW,             33,    0,     147)
DECLARE_NORMAL(  CAPTURE_HISTORY_WEIGHT,             359,  286,     433)
#endif /* CAPTURE_HISTORY */

#if CONTINUATION_HISTORY
DECLARE_NORMAL(  CONTINUATION_HISTORY_WEIGHT,        119,   46,     193)
DECLARE_NORMAL(  FOLLOWUP_HISTORY_WEIGHT,            136,   63,     210)
DECLARE_VALUE(  CONTINUATION_HISTORY_MIN_DEPTH,       2,    0,       7)
DECLARE_NORMAL(  CONTINUATION_HISTORY_LMR_DIV,       592,  519,     666)
DECLARE_NORMAL(  CONTINUATION_HISTORY_PRUNING,        44,    0,     147)
#endif /* CONTINUATION_HISTORY */

DECLARE_NORMAL(  COUNTER_MOVE_BONUS,                 204,  131,     278)
DECLARE_VALUE(  COUNTER_MOVE_MIN_DEPTH,               2,    0,       5)

DECLARE_NORMAL(  HIST_MAX,                         25243, 25095,  25392)
DECLARE_NORMAL(  HISTORY_SCORE_DIV,                   86,    12,    159)
DECLARE_NORMAL(  HISTORY_SCORE_MUL,                  395,  200,    600)
