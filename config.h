...
DECLARE_VALUE(  LMP_BASE,                           190,  100,    1000)
DECLARE_VALUE(  LMP_BASE_IMPROVED,                  289,  100,    1000)
DECLARE_VALUE(  LMP_COEFF,                          245,  100,    1000)
DECLARE_VALUE(  LMP_COEFF_IMPROVED,                 315,  100,    1000)

DECLARE_VALUE(  LMR_BASE,                             0,    0,    1000)
DECLARE_VALUE(  LMR_COEFF,                          100,    0,    1000)
...
#if WITH_NNUE
DECLARE_VALUE(  NNUE_EVAL_TERM,                     628,    0,    1000)
DECLARE_VALUE(  NNUE_MARGIN_BASE,                   464,    0,    1000)
DECLARE_VALUE(  NNUE_MARGIN_COEFF,                  116,    0,    1000)
DECLARE_VALUE(  NNUE_MARGIN_BASE_EG,                482,    0,    1000)
DECLARE_VALUE(  NNUE_MARGIN_COEFF_EG,                93,    0,    1000)
#endif /* WITH_NNUE */
