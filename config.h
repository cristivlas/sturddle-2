...
#endif
DECLARE_VALUE(  LMP_BASE,                           166,  100,    1000)
DECLARE_VALUE(  LMP_BASE_I,                         251,  100,    1000)
DECLARE_VALUE(  LMP_COEFF,                          154,  100,    1000)
DECLARE_VALUE(  LMP_COEFF_I,                        163,  100,    1000)
DECLARE_VALUE(  LMP_ITERATION,                        8,    1,     100)
