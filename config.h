...
DECLARE_VALUE(  NULL_MOVE_DIV,                      129,    1,    1000)
DECLARE_VALUE(  NULL_MOVE_REDUCTION,                  4,    0,     100)
DECLARE_VALUE(  NULL_MOVE_IMPROVEMENT_DIV,           50,    1,    1000)
DECLARE_VALUE(  NULL_MOVE_MARGIN,                   350,    0,    1000)
...
DECLARE_VALUE(  HISTORY_SCORE_DIV,                   77,    1,     100)
DECLARE_VALUE(  HISTORY_FAIL_LOW_MARGIN,           2303,    0,    2500)
DECLARE_VALUE(  HISTORY_FAIL_LOW_PENALTY,             0,    0,     100)
