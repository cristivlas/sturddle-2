...
DECLARE_VALUE(  IMPROVEMENT_MARGIN,                   1,    0,     200)
DECLARE_VALUE(  LATE_MOVE_REDUCTION_COUNT,            4,    0,     100)
DECLARE_VALUE(  LMP_ALPHA,                           19,    0,     100)
DECLARE_VALUE(  LMP_BETA,                            37,    1,     100)
DECLARE_VALUE(  LMP_BASE,                           176,  100,    1000)
DECLARE_VALUE(  LMP_BASE_I,                         212,  100,    1000)
DECLARE_VALUE(  LMP_COEFF,                          137,  100,    1000)
DECLARE_VALUE(  LMP_COEFF_I,                        141,  100,    1000)
DECLARE_VALUE(  LMR_BASE,                            53,    0,    1000)
DECLARE_VALUE(  LMR_COEFF,                           53,    0,    1000)
