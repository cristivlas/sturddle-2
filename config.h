...
#if CAPTURE_HISTORY
DECLARE_VALUE(  CAPTURE_HISTORY_LMR_HIGH,           139,  100,     200)
DECLARE_VALUE(  CAPTURE_HISTORY_LMR_LOW,             54,   40,     100)
DECLARE_VALUE(  CAPTURE_HISTORY_WEIGHT,             413,  360,     500)
#endif /* CAPTURE_HISTORY */

#if CONTINUATION_HISTORY
DECLARE_PARAM(  CONTINUATION_HISTORY_WEIGHT,        152,  100,     250)
DECLARE_PARAM(  FOLLOWUP_HISTORY_WEIGHT,             73,   50,     200)
DECLARE_VALUE(  CONTINUATION_HISTORY_MIN_DEPTH,       2,    0,       7)
DECLARE_PARAM(  CONTINUATION_HISTORY_LMR_DIV,       525,  256,     768)
DECLARE_PARAM(  CONTINUATION_HISTORY_PRUNING,        84,   50,     200)
#endif /* CONTINUATION_HISTORY */

DECLARE_PARAM(  COUNTER_MOVE_BONUS,                 200,  150,     230)
DECLARE_VALUE(  COUNTER_MOVE_MIN_DEPTH,               2,    0,       5)

DECLARE_PARAM(  HISTORY_SCORE_DIV,                   86,   50,     100)
DECLARE_PARAM(  HISTORY_SCORE_MUL,                  261,  200,     280)
