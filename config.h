...
GROUP(Search)
#if 0
DECLARE_VALUE(  ACCURACY_MARGIN,                    323,    0,    1000)
#endif
...
DECLARE_VALUE(  NNUE_EVAL_SCALE,                    777,    0,    1000)
...
DECLARE_VALUE(  NULL_MOVE_MAX,                        5,    0,     100)
...
DECLARE_VALUE(  SINGULAR_ACCURACY_MARGIN,            50,    0,     500)
