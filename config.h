...
DECLARE_VALUE(  LMP_BASE_IMPROVED,                  295,  100,    1000)
DECLARE_VALUE(  LMP_COEFF,                          228,  100,    1000)
DECLARE_VALUE(  LMP_COEFF_IMPROVED,                 300,  100,    1000)

DECLARE_VALUE(  LMR_BASE,                            68,    0,    1000)
DECLARE_VALUE(  LMR_COEFF,                           59,    0,    1000)
...
#if WITH_NNUE
DECLARE_VALUE(  NNUE_EVAL_TERM,                     653,    0,    1000)
DECLARE_VALUE(  NNUE_MARGIN_BASE,                   473,    0,    1000)
DECLARE_VALUE(  NNUE_MARGIN_COEFF,                  108,    0,    1000)
DECLARE_VALUE(  NNUE_MARGIN_BASE_EG,                446,    0,    1000)
DECLARE_VALUE(  NNUE_MARGIN_COEFF_EG,                94,    0,    1000)
#endif /* WITH_NNUE */
