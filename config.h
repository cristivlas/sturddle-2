...
DECLARE_VALUE(  LMP_BASE,                           189,  100,    1000)
DECLARE_VALUE(  LMP_BASE_I,                         225,  100,    1000)
DECLARE_VALUE(  LMP_COEFF,                          124,  100,    1000)
DECLARE_VALUE(  LMP_COEFF_I,                        154,  100,    1000)
DECLARE_VALUE(  LMP_ITERATION,                       10,    1,     100)
DECLARE_VALUE(  LMR_BASE,                            67,    0,    1000)
DECLARE_VALUE(  LMR_COEFF,                           39,    0,    1000)
