...
#if CAPTURE_HISTORY
DECLARE_NORMAL(  CAPTURE_HISTORY_LMR_HIGH,           139,  100,     200)
DECLARE_NORMAL(  CAPTURE_HISTORY_LMR_LOW,             54,   40,     100)
DECLARE_NORMAL(  CAPTURE_HISTORY_WEIGHT,             413,  360,     500)
#endif /* CAPTURE_HISTORY */

#if CONTINUATION_HISTORY
DECLARE_NORMAL(  CONTINUATION_HISTORY_WEIGHT,        153,  100,     250)
DECLARE_NORMAL(  FOLLOWUP_HISTORY_WEIGHT,             65,   50,     200)
DECLARE_VALUE(  CONTINUATION_HISTORY_MIN_DEPTH,       2,    0,       7)
DECLARE_NORMAL(  CONTINUATION_HISTORY_LMR_DIV,       560,  256,     768)
DECLARE_NORMAL(  CONTINUATION_HISTORY_PRUNING,        71,   50,     200)
#endif /* CONTINUATION_HISTORY */

DECLARE_NORMAL(  COUNTER_MOVE_BONUS,                 198,  150,     230)
DECLARE_VALUE(  COUNTER_MOVE_MIN_DEPTH,               2,    0,       5)

DECLARE_NORMAL(  HISTORY_SCORE_DIV,                   85,   50,     100)
DECLARE_NORMAL(  HISTORY_SCORE_MUL,                  264,  200,     280)
