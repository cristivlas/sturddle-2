...
Config::Namespace Config::_namespace = {
    ...
    /* Piece weights */
    { "PAWN", Config::Param{ &WEIGHT[PieceType::PAWN], 60, 110, "Eval", normalize_weights} },
...
DECLARE_VALUE(  MULTICUT_MARGIN,                    161,    0,     441)
...
DECLARE_VALUE(  NNUE_MAX_EVAL,                      517,  249,     690)
#endif /* WITH_NNUE */

/* is_null_move_ok */
DECLARE_VALUE(  NULL_MOVE_DEPTH_WEIGHT_PCT,         220,   84,     525)
DECLARE_VALUE(  NULL_MOVE_MARGIN,                   215,   98,     539)
...
DECLARE_VALUE(  NULL_MOVE_REDUCTION_DIV,            108,    1,     442)
