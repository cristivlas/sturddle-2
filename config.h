...
#if CAPTURE_HISTORY
DECLARE_VALUE(  CAPTURES_HISTORY_THRESHOLD,        6500,    0,   15000)
#endif
...
#endif
DECLARE_VALUE(  LMP_BASE,                           164,  100,    1000)
DECLARE_VALUE(  LMP_BASE_I,                         242,  100,    1000)
DECLARE_VALUE(  LMP_COEFF,                          134,  100,    1000)
DECLARE_VALUE(  LMP_COEFF_I,                        172,  100,    1000)
DECLARE_VALUE(  LMP_ITERATION,                       10,    1,     100)
...
DECLARE_VALUE(  NULL_MOVE_DIV,                      243,    1,    1000)
DECLARE_VALUE(  NULL_MOVE_REDUCTION,                  4,    0,     100)
DECLARE_VALUE(  NULL_MOVE_IMPROVEMENT_DIV,           62,    1,    1000)
