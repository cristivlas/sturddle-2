...
DECLARE_VALUE(  NULL_MOVE_DIV,                      207,    1,    1000)
DECLARE_VALUE(  NULL_MOVE_FAIL_PENALTY,              55,    0,    1000)
DECLARE_VALUE(  NULL_MOVE_REDUCTION,                  4,    0,     100)
DECLARE_VALUE(  NULL_MOVE_IMPROVEMENT_DIV,           96,    1,    1000)
DECLARE_VALUE(  NULL_MOVE_MARGIN,                   694,    0,    1000)
DECLARE_VALUE(  NULL_MOVE_MIN_VERIFICATION_DEPTH,    15,    0,     100)
