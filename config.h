...
DECLARE_VALUE(  IMPROVEMENT_MARGIN,                  46,    0,     200)
...
#if CAPTURE_HISTORY
DECLARE_VALUE(  CAPTURE_HISTORY_LMR_HIGH,           197,   50,     400)
DECLARE_VALUE(  CAPTURE_HISTORY_LMR_LOW,             49,    0,     150)
DECLARE_VALUE(  CAPTURE_HISTORY_WEIGHT,             467,  100,    1024)
