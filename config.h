...
DECLARE_VALUE(  CONTINUATION_HISTORY_WEIGHT,        150,  100,     250)
DECLARE_VALUE(  FOLLOWUP_HISTORY_WEIGHT,            100,   50,     200)
DECLARE_VALUE(  CONTINUATION_HISTORY_MIN_DEPTH,       2,    0,       7)
DECLARE_VALUE(  CONTINUATION_HISTORY_LMR_DIV,       512,  256,     768)
DECLARE_VALUE(  CONTINUATION_HISTORY_PRUNING,       100,   50,     200)
