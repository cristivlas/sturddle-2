...
DECLARE_VALUE(  MULTICUT_MARGIN,                    182,   20,     200)
...
/* is_null_move_ok */
DECLARE_VALUE(  NULL_MOVE_DEPTH_WEIGHT_PCT,          53,   50,    1000)
DECLARE_VALUE(  NULL_MOVE_MARGIN,                    90,   40,     250)
...
#if CAPTURE_HISTORY
DECLARE_NORMAL(  CAPTURE_HISTORY_LMR_HIGH,           127,   80,     200)
DECLARE_NORMAL(  CAPTURE_HISTORY_LMR_LOW,             56,   40,     100)
DECLARE_NORMAL(  CAPTURE_HISTORY_WEIGHT,             330,  250,     500)
#endif /* CAPTURE_HISTORY */

#if CONTINUATION_HISTORY
DECLARE_NORMAL(  CONTINUATION_HISTORY_WEIGHT,        110,  100,     250)
DECLARE_NORMAL(  FOLLOWUP_HISTORY_WEIGHT,            125,   50,     200)
DECLARE_VALUE(  CONTINUATION_HISTORY_MIN_DEPTH,       2,    0,       7)
DECLARE_NORMAL(  CONTINUATION_HISTORY_LMR_DIV,       445,  256,     768)
DECLARE_NORMAL(  CONTINUATION_HISTORY_PRUNING,        70,   50,     200)
#endif /* CONTINUATION_HISTORY */

DECLARE_NORMAL(  COUNTER_MOVE_BONUS,                 191,  150,     250)
DECLARE_VALUE(  COUNTER_MOVE_MIN_DEPTH,               2,    0,       5)

DECLARE_NORMAL(  HIST_MAX,                         16384, 2048,   32768)
DECLARE_NORMAL(  HISTORY_SCORE_DIV,                   73,   50,     100)
DECLARE_NORMAL(  HISTORY_SCORE_MUL,                  279,  200,     400)
