...
#if CAPTURE_HISTORY
DECLARE_NORMAL(  CAPTURE_HISTORY_LMR_HIGH,           123,   80,     200)
DECLARE_NORMAL(  CAPTURE_HISTORY_LMR_LOW,             55,   40,     100)
DECLARE_NORMAL(  CAPTURE_HISTORY_WEIGHT,             366,  250,     500)
#endif /* CAPTURE_HISTORY */

#if CONTINUATION_HISTORY
DECLARE_NORMAL(  CONTINUATION_HISTORY_WEIGHT,        132,  100,     250)
DECLARE_NORMAL(  FOLLOWUP_HISTORY_WEIGHT,            127,   50,     200)
DECLARE_VALUE(  CONTINUATION_HISTORY_MIN_DEPTH,       2,    0,       7)
DECLARE_NORMAL(  CONTINUATION_HISTORY_LMR_DIV,       479,  256,     768)
DECLARE_NORMAL(  CONTINUATION_HISTORY_PRUNING,        83,   50,     200)
#endif /* CONTINUATION_HISTORY */

DECLARE_NORMAL(  COUNTER_MOVE_BONUS,                 187,  150,     250)
DECLARE_VALUE(  COUNTER_MOVE_MIN_DEPTH,               2,    0,       5)

DECLARE_NORMAL(  HISTORY_SCORE_DIV,                   80,   50,     100)
DECLARE_NORMAL(  HISTORY_SCORE_MUL,                  280,  200,     400)
