...
#if CAPTURE_HISTORY
DECLARE_NORMAL(  CAPTURE_HISTORY_LMR_HIGH,           108,   40,     160)
DECLARE_NORMAL(  CAPTURE_HISTORY_LMR_LOW,             45,    0,      80)
DECLARE_NORMAL(  CAPTURE_HISTORY_WEIGHT,             349,  200,     500)
#endif /* CAPTURE_HISTORY */

#if CONTINUATION_HISTORY
DECLARE_NORMAL(  CONTINUATION_HISTORY_WEIGHT,        158,   50,     250)
DECLARE_NORMAL(  FOLLOWUP_HISTORY_WEIGHT,            137,  100,     160)
DECLARE_VALUE(  CONTINUATION_HISTORY_MIN_DEPTH,       2,    0,       7)
DECLARE_NORMAL(  CONTINUATION_HISTORY_LMR_DIV,       582,  500,     700)
DECLARE_NORMAL(  CONTINUATION_HISTORY_PRUNING,        53,    0,     100)
#endif /* CONTINUATION_HISTORY */

DECLARE_NORMAL(  COUNTER_MOVE_BONUS,                 215,  180,     240)
