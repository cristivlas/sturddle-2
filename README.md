...
This version of the engine uses an original model nicknamed **Raptor-II**, which expands on the bucketing idea introduced
in 2.4.0 with the **Bluejay** architecture, by adding bucket-shifting in the "spatial attention" modulation path.
