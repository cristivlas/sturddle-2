...
#define GRADING_ADJUST { \
    { 0,  22, -100, -103, -105, -308, 0 }, /*   0-4 pawns: 128, 240, 260, 421,  727 */ \
    { 0,  29,   56,   64,  115,  163, 0 }, /*   5-8 pawns: 135, 396, 427, 641, 1198 */ \
    { 0,   4,   60,   62,   81,  181, 0 }, /*  9-12 pawns: 110, 400, 425, 607, 1216 */ \
    { 0, -43,  -40,  -47, -105, -111, 0 }, /* 13-16 pawns:  63, 300, 316, 421,  924 */ \
}
    ...
    INLINE bool State::has_insufficient_material(Color color) const
    {
